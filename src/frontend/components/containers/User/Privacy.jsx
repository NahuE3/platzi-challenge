...
const Privacy = () => {
  return (
    <Layout title="Sobre Nosotros" subtitle="Informacions sobre Foody" center={true}>
      <StyledWrapper>
        <StyledSeparator>
        ...
        <p>
          ...
          FoodyPlus usa y protege la información que es proporcionada por sus
        ...
        <p>
          FoodyPlus está altamente comprometido para cumplir con el compromiso
        ...
        <p>
          ...
          quiera y la proporcione directamente, <a href="" target="_blank"></a>.
        ...
        <p>
          FoodyPlus Se reserva el derecho de cambiar los términos de la presente
